...
import recipe from "./assets/Food-Recipe-Finder.png";
...
const introdata = {
  ...
  description:
    "I will make your ideas come alive on the internet with my web development skills.",
  getConnect: "Get your website built now!",
...
const worktimeline = [
  {
    jobtitle: "Associate Engineer (React)",
...
const contactConfig = {
  YOUR_EMAIL: "ramlaxman947@gmail.com",
  YOUR_FONE: "+91 8686606625",
  description: "Just leave me a message and I will get back to you!",
