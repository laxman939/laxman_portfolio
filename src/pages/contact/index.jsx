...
import mailGiff from "../../assets/Mail_sent.gif";
              ...
              <Row>
                <Col lg="" className="">
                  <div className="d-flex gap-2 align-items-center">
                    ...
                    <h5>I value your thoughts and feedback!</h5>
                  </div>
                  <section className="feedback-section">
                    <p>
                      Whether it's a suggestion for a new project, constructive
                      criticism, or just some feedback on how to improve the
                      user experience, I’d love to hear from you. I’m always
                      open to new ideas and excited to incorporate them into my
                      future work.
                    </p>
                  </section>
